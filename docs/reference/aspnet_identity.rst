...
The repo for this support is located `here <https://www.nuget.org/packages/VkSoft.Community.IdentityServer10.AspNetIdentity/>`_ and the NuGet package is `here <https://www.nuget.org/packages/VkSoft.Community.IdentityServer10.AspNetIdentity>`_.
