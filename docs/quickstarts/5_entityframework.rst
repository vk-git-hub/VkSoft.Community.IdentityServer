...
.. Note:: You can find the `latest SQL scripts <https://www.nuget.org/packages/VkSoft.Community.IdentityServer10/tree/main/src/EntityFramework.Storage/migrations/SqlServer/Migrations>`_ for SqlServer in the IdentityServer8.EntityFramework.Storage repository.
