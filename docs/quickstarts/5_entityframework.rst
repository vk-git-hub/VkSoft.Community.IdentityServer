...
.. Note:: You can find the `latest SQL scripts <https://github.com/omarbaruzzo/IdentityServer8/tree/main/src/EntityFramework.Storage/migrations/SqlServer/Migrations>`_ for SqlServer in the IdentityServer8.EntityFramework.Storage repository.
