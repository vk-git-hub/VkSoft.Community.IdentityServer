...
(see the full file `here <https://github.com/omarbaruzzo/IdentityServer8/blob/main/samples/Quickstarts/1_ClientCredentials/src/IdentityServer/Config.cs>`_).
...
^^^^^^^^^^^^^^^^^^^^^^^^^^
Loading the resource and client definitions happens in `Startup.cs <https://github.com/omarbaruzzo/IdentityServer8/blob/main/samples/Quickstarts/1_ClientCredentials/src/IdentityServer/Startup.cs>`_ - update the code to look like this::
...
Configure the API application to run on ``https://localhost:6001`` only. You can do this by editing the `launchSettings.json <https://github.com/omarbaruzzo/IdentityServer8/blob/main/samples/Quickstarts/1_ClientCredentials/src/Api/Properties/launchSettings.json>`_ file inside the Properties folder. Change the application URL setting to be::
...
(full file can be found `here <https://github.com/omarbaruzzo/IdentityServer8/blob/main/samples/Quickstarts/1_ClientCredentials/src/Client/Program.cs>`_)
