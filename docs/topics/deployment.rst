...
For databases we provide support for `Entity Framework Core <https://www.nuget.org/packages/VkSoft.Community.IdentityServer10.EntityFramework>`_ based databases.
