...
or use the `identity server authentication handler <https://www.nuget.org/packages/VkSoft.Community.IdentityServer10.AccessTokenValidation>`_ which can validate both JWTs and reference tokens.
